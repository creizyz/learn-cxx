...
This is not a problem at all when using <span style="color:green;">**simple types**</span> (integers, booleans, etc...), it can actually be faster for these types. But it can create performance issues (execution time, memory usage) when using more <span style="color:red;">**complex types**</span> (here a mesh).
